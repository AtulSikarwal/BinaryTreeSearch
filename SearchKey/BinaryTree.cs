...
namespace BinaraySearchTree
{
    public class BinarySearchTree<K> where K:IComparable
    {
        ...
        public BinarySearchTreeNode<K> AddRecursively(BinarySearchTreeNode<K> Current, K Key)
        {
            if (Current == null)
        ...
        public  int getSizeRecursively(BinarySearchTreeNode<K> Current)
        {
            return Current == null ? 0: 1 + this.getSizeRecursively(Current.Left) +this.getSizeRecursively(Current.Right);
        }


        public bool SearchRecursively(BinarySearchTreeNode<K> Current, K Key)
        {
            if (Current == null)
                return false;
